  ...
  return (
    <section className="relative z-10 max-w-6xl mx-auto px-6 pt-16 pb-16 md:pt-24 md:pb-24 text-center">
      ...
      <div className="mt-8 flex items-center justify-center gap-3">
        <a href="/shop" className="px-6 h-12 rounded-full bg-foreground text-background shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-black/15 hover:-translate-y-0.5 transition will-change-transform">
          Shop Collection
        </a>
